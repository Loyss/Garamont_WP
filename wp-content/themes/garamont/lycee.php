...
<?php get_header(); ?>
    ...
    <div class="lycee">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-0 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 text-center">
                    <div class="row">
                        ...
                        <p><b><i>Auteur</i></b></p>
                        <button OnClick="window.location.href='<?php bloginfo('url'); ?>/histoire'" class="btn btn-histoire">Histoire</button>
                    </div>
                </div>
        ...
        <div class="container-fluid  paragraphes-section garamond">
            <?php
            $c = 0;
            $myquery = new WP_Query(array('post_type' => 'articles_lycee'));
            ?>
